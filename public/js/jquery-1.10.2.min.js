...
!(function (a, b) {
  ...
  d.prototype = {
    ...
    update: function () {
      ...
      ;(this.slidesOrder.length = 0),
        ...
        b.isFunction(this.settings.update) && this.settings.update.call(this, { type: 'update' })
    },
    ...
    resize: function () {
      ...
      this.settings.responsive === !0
        ...
        (this.previousSlideWidth !== this.slideWidth ||
          ...
          (this.previousSlideHeight = this.slideHeight),
          (this.slideSize =
            'horizontal' === this.settings.orientation ? this.slideWidth : this.slideHeight),
      ...
      if (a !== this.selectedSlideIndex && 'undefined' != typeof this.slides[a]) {
        ...
        this._moveTo(d, !1, function () {
          c.settings.loop === !0 && c._resetSlidesPosition(),
            c.trigger({ type: 'gotoSlideComplete', index: a, previousIndex: c.previousSlideIndex }),
          ...
          this.trigger({ type: 'gotoSlide', index: a, previousIndex: this.previousSlideIndex }),
    ...
    _resizeHeightTo: function (a) {
      var b = { height: a }
      'css-3d' === this.supportedAnimation || 'css-2d' === this.supportedAnimation
        ? ((b[this.vendorPrefix + 'transition'] =
            'height ' + this.settings.heightAnimationDuration / 1e3 + 's'),
          this.$slidesMask.css(b))
        : this.$slidesMask.animate(b, this.settings.heightAnimationDuration)
    },
    destroy: function () {
  ...
  ;(e.prototype = {
    _init: function () {
      this.$slide.attr('data-init', !0),
        (this.$mainImage =
          0 !== this.$slide.find('.sp-image').length ? this.$slide.find('.sp-image') : null),
        null !== this.$mainImage &&
          ((this.hasMainImage = !0),
          (this.$imageContainer = b('<div class="sp-image-container"></div>').prependTo(
            this.$slide
          )),
  ...
  var f = {
    ...
    checkIE: function () {
      ...
      return (
        (this.isIE = -1 !== b.indexOf('MSIE') || b.match(/Trident.*rv\:11\./) ? !0 : !1), this.isIE
      )
    }
  }
  a.SliderProUtils = f
          ...
          this.$thumbnails.find('.sp-thumbnail').each(function (c) {
            ...
            b.each(this.thumbnails, function (b, c) {
              c.setSize(a.settings.thumbnailWidth, a.settings.thumbnailHeight),
                (a.thumbnailsSize +=
                  'horizontal' === a.thumbnailsOrientation ? c.getSize().width : c.getSize().height)
            }),
          ...
          if (a !== this.thumbnailsPosition)
            if (
              ...
              (f['margin-' + this.thumbnailsPositionProperty] = a),
                'undefined' != typeof c && c === !0
                  ? this.$thumbnails.css(f)
                  : this.$thumbnails.addClass('sp-animated').animate(f, 700, function () {
                      e.$thumbnails.removeClass('sp-animated'),
                        'function' == typeof d && d(),
                        e.trigger({ type: 'thumbnailsMoveComplete' }),
                        b.isFunction(e.settings.thumbnailsMoveComplete) &&
                ...
                'undefined' != typeof c.attr('data-retina' + a.currentImageSize)
                  ? ((e = c.attr('data-retina' + a.currentImageSize)),
                    'undefined' != typeof c.attr('data-retina') &&
                      ...
                      c.attr('data-retina', e))
                  : (a.isRetinaScreen === !1 ||
                      (a.isRetinaScreen === !0 && 'undefined' == typeof c.attr('data-retina'))) &&
        ...
        initRetina: function () {
          this._isRetina() !== !1 &&
            ...
            0 !== this.$slider.find('.sp-thumbnail').length &&
              this.on('update.Thumbnails.' + c, b.proxy(this._checkRetinaThumbnailImages, this)))
        },
        _isRetina: function () {
          return a.devicePixelRatio >= 2
            ? !0
            : a.matchMedia &&
                a.matchMedia('(-webkit-min-device-pixel-ratio: 2),(min-resolution: 2dppx)').matches
              ? !0
              : !1
        },
    ...
    var c = 'Layers.' + b.SliderPro.namespace,
      d = {
        ...
        _layersGotoSlide: function (a) {
          ...
          this.$slider.hasClass('sp-swiping') || 'undefined' == typeof d || 0 === d.length
    ...
    ;(f.prototype = {
      ...
      _setPosition: function () {
        ...
        ;(this.horizontalPosition =
          'undefined' != typeof this.data.horizontal ? this.data.horizontal : 0),
            ...
            ;(g[this.vendorPrefix + 'transform'] = 'scale(' + this.scaleRatio + ')'),
              ...
              this.$layer.on(this.transitionEvent, function (c) {
                c.target === c.currentTarget &&
                  (b.$layer.off(b.transitionEvent).css(b.vendorPrefix + 'transition', ''),
                  -1 !== f &&
                    (b.stayTimer = setTimeout(function () {
                      b.hide(), (b.stayTimer = null)
                    }, f)),
      ...
      hide: function (a) {
        if (this.visible !== !1) {
          var c = this,
            ...
            e = 'undefined' != typeof this.data.hideDuration ? this.data.hideDuration / 1e3 : 0.4,
            ...
            ;(h[this.vendorPrefix + 'transform'] = 'scale(' + this.scaleRatio + ')'),
              ...
              this.$layer.on(this.transitionEvent, function (b) {
                b.target === b.currentTarget &&
                  (c.$layer.off(c.transitionEvent).css(c.vendorPrefix + 'transition', ''),
            ...
            if (this.$slider.hasClass('sp-swiping')) this.fadeGotoSlideReference(a)
              ...
              b.each(this.slides, function (a, b) {
                var g = b.getIndex(),
                  h = b.$slide
                g === f
                  ? (h.css({ opacity: 0, left: 0, top: 0, 'z-index': 20 }), (c = h))
                  : g === e.selectedSlideIndex
                    ? (h.css({ opacity: 1, left: 0, top: 0, 'z-index': 10 }), (d = h))
        ...
        initTouchSwipe: function () {
          this.settings.touchSwipe !== !1 &&
            ...
            (this.touchSwipeEvents.endEvent =
              'touchend.' + this.uniqueId + '.' + c + ' mouseup.' + this.uniqueId + '.' + c),
            this.$slidesMask.on(
        ...
        _captionOnUpdate: function () {
          ;(this.$captionContainer = this.$slider.find('.sp-caption-container')),
            this.$slider.find('.sp-caption').length &&
              ...
              ((this.$captionContainer = b('<div class="sp-caption-container"></div>').appendTo(
                this.$slider
              )),
        ...
        _fadeCaptionTo: function (a, b) {
          ...
          'css-3d' === this.supportedAnimation || 'css-2d' === this.supportedAnimation
            ...
            : this.$captionContainer
                .stop()
                .animate({ opacity: a }, this.settings.captionFadeDuration, function () {
                  'function' == typeof b && b()
                })
        },
        ...
        _arrowsOnUpdate: function () {
          ...
          this.settings.arrows === !0 && null === this.$arrows
            ? ((this.$arrows = b('<div class="sp-arrows"></div>').appendTo(this.$slidesContainer)),
              (this.$previousArrow = b('<div class="sp-arrow sp-previous-arrow"></div>').appendTo(
                this.$arrows
              )),
              (this.$nextArrow = b('<div class="sp-arrow sp-next-arrow"></div>').appendTo(
                this.$arrows
              )),
        ...
        _thumbnailArrowsOnUpdate: function () {
          ...
          this.isThumbnailScroller !== !1 &&
            (this.settings.thumbnailArrows === !0 && null === this.$thumbnailArrows
              ? ((this.$thumbnailArrows = b('<div class="sp-thumbnail-arrows"></div>').appendTo(
                  this.$thumbnailsContainer
                )),
            ...
            a.on('click.' + c, function (c) {
              if (!d.$slider.hasClass('sp-swiping')) {
                ...
                ;-1 !== l.indexOf('youtube') || -1 !== l.indexOf('youtu.be')
                  ...
                  (e = b('<iframe></iframe>')
                    .attr({ src: j, width: m, height: n, class: a.attr('class'), frameborder: 0 })
                    .insertBefore(a)),
                  d._initVideo(e),
  ...
  (function (a) {
    ...
    ;(j.prototype = new d()),
      ...
      (j.isType = function (a) {
        return ('undefined' == typeof a.attr('data-videojs-id') && !a.hasClass('video-js')) ||
...
!(function (t) {
  t.slidebars = function (s) {
    function e() {
      !c.disableOver || ('number' == typeof c.disableOver && c.disableOver >= k)
        ? ((w = !0),
          ...
          c.hideControlClasses && T.removeClass('sb-hide'),
          i())
        : 'number' == typeof c.disableOver &&
          c.disableOver < k &&
          ((w = !1),
          t('html').removeClass('sb-init'),
          c.hideControlClasses && T.addClass('sb-hide'),
          g.css('minHeight', ''),
          (p || y) && o())
    }
    function i() {
      ...
      e > s && g.css('minHeight', t('dddd').css('height')),
        m && m.hasClass('sb-width-custom') && m.css('width', m.attr('data-sb-width')),
        C && C.hasClass('sb-width-custom') && C.css('width', C.attr('data-sb-width')),
        m &&
          (m.hasClass('sb-style-push') || m.hasClass('sb-style-overlay')) &&
          m.css('marginLeft', '-' + m.css('width')),
        C &&
          (C.hasClass('sb-style-push') || C.hasClass('sb-style-overlay')) &&
          C.css('marginRight', '-' + C.css('width')),
    ...
    function a(s) {
      function e() {
        w && 'left' === s && m
          ? (t('html,.thatheme-ghost').addClass('sb-active sb-active-left'),
          ...
          : w &&
            ...
            C.addClass('sb-active'),
            n(C, '-' + C.css('width'), 'right'),
            setTimeout(function () {
              y = !0
            }, 400))
      }
    ...
    function o(s, e) {
      ;(p || y) &&
        ...
        y && (n(C, '0px', 'right'), (y = !1)),
        setTimeout(function () {
          t('html,.thatheme-ghost').removeClass('sb-active sb-active-left sb-active-right'),
            m && m.removeClass('sb-active'),
            C && C.removeClass('sb-active'),
            'undefined' != typeof s && (void 0 === typeof e && (e = '_self'), window.open(s, e))
        }, 400))
    }
    function l(t) {
    ...
    ;/Android/.test(u)
      ...
      : /(iPhone|iPod|iPad)/.test(u) && (v = u.substr(u.indexOf('OS ') + 3, 3).replace('_', '.')),
      ((b && 3 > b) || (v && 5 > v)) && t('html').addClass('sb-static')
    var g = t('#thaitheme-waper, .thaitheme-waper-container')
    if (t('.sb-left').length)
      var m = t('.sb-left'),
        p = !1
    ...
    var w = !1,
      k = t(window).width(),
      T = t(
        '.sb-toggle-left, .sb-toggle-right, .sb-open-left, .sb-open-right, .sb-close,.thatheme-ghost'
      ),
      O = t('.sb-slide')
    e(),
    ...
    d && f ? ((x = 'translate'), b && 4.4 > b && (x = 'side')) : (x = 'jQuery'),
      ...
      t('.sb-close,.thatheme-ghost').on('touchend click', function (s) {
...
;(function ($, window, document, undefined) {
  ...
  var width = { el: 0, stage: 0, item: 0, prevWindow: 0, cloneLast: 0 }
  var num = { items: 0, oItems: 0, cItems: 0, active: 0, merged: [], nav: [], allPages: 0 }
  var pos = {
    start: 0,
    max: 0,
    maxValue: 0,
  ...
  var speed = { onDragEnd: 300, nav: 300, css2speed: 0 }
  var state = {
    isTouch: false,
    isScrolling: false,
    isSwiping: false,
  ...
  Owl.prototype.createVideoTn = function (videoEl, info) {
    ...
    function addThumbnail(tnPath) {
      ...
      if (that.options.lazyLoad) {
        ...
        tnLink =
          '<div class="owl-video-tn" style="opacity:1;background-image:url(' + tnPath + ')"></div>'
      }
  ...
  Owl.prototype.calculate = function () {
    ...
    var elMinusMargin =
      this.width.el - this.options.margin * (this.options.items === 1 ? 0 : this.options.items - 1)
  ...
  Owl.prototype.updateLazyPosition = function () {
    ...
    this.pos.lcCurrentAbs =
      this.pos.lcCurrent < 0 ? this.pos.lcCurrent + this.dom.$content.length : this.pos.lcCurrent
  }
  ...
  Owl.prototype.updateEvents = function () {
    if (
      ...
      (this.dragType[0] === 'touchstart' || this.dragType[0] === 'MSPointerDown')
    ) {
  ...
  Owl.prototype.onDragStart = function (event) {
    ...
    if (this.options.rtl) {
      this.drag.offsetX =
        this.dom.$stage.position().left + this.width.stage - this.width.el + this.options.margin
    }
